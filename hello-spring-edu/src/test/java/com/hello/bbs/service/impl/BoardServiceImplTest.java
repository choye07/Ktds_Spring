...
public class BoardServiceImplTest {
	...
	public void getTest() {
		...
		// given
		BDDMockito.given(this.boardDaoImpl.selectBoardAllCount(null)).willReturn(100);
		BDDMockito.given(this.boardDaoImpl.selectAllBoard(null))
		...
		BoardListVO boardListVO = this.boardService.getBoardList(null);
