...
<div class="detail-wrapper">
	<div class="grid">
		...
		<sec:authorize access="hasRole('ROLE_ADMIN') or @rah.isBoardOwner(#BoardVO.id)">
	...
	<li>
		...
		<div class="reply-item-actions">
			<span class="reply-item-modify">수정</span> 
			 <span
				class="reply-item-delete">삭제</span> <span
				class="reply-item-recommend">추천</span> <span
				class="reply-item-recommend-count"></span> <span
				class="reply-item-write">답글 달기</span>
		</div>
	</li>
</template>
